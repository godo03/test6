...
public class MyAdapterVideoGames extends BaseAdapter {

    Context context;
    ArrayList <PlayerVideoGames> playerArrayList;

    public MyAdapterVideoGames(Context context, ArrayList<PlayerVideoGames> playerArrayList){
  ...
  /*  @Override
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        result = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_videogames, viewGroup, false);
       ...
       TextView idtv = result.findViewById(R.id.id_item_list);
        ...
        PlayerVideoGames player = playerArrayList.get(position);
