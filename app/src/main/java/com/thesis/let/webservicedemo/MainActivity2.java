...
import com.thesis.let.webservicedemo.screens.ResultActivity2;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDb = new DatabaseHelperBooks(this);
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (timeValue == -1 && qid > 9) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            onStop();
                            Toast.makeText(MainActivity2.this, "Loading questions... Please wait", Toast.LENGTH_LONG).show();
    ...
    void loadQ()
    {
        ...
        if ((token!=null))
            ...
            url ="&category=10";
        url = "https://opentdb.com/api.php?amount=10&category=10"+url;
    ...
    public void endGameDialog(Integer score) {
        final Dialog endDialog = new Dialog(MainActivity2.this);
