...
public class MyAdapterAnime extends BaseAdapter {

    Context context;
    ArrayList<PlayerAnime> playerArrayList;

    public MyAdapterAnime(Context context, ArrayList<PlayerAnime> playerArrayList){
  ...
  /*  @Override
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        result = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_anime, viewGroup, false);
        ...
        PlayerAnime player = playerArrayList.get(position);
