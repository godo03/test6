...
public class DatabaseHelperVideoGames extends SQLiteOpenHelper {

    public static int DB_VERSION = 1;
    public static String DB_NAME = "PlayerVideoGames.db";
    ...
    public DatabaseHelperVideoGames(@Nullable Context context) {
    ...
    public boolean deleteData (PlayerVideoGames id){
   ...
   */
  public ArrayList<PlayerVideoGames> getAllData(){
      ArrayList<PlayerVideoGames> playerArrayList = new ArrayList<>();
      ...
      while (cursor.moveToNext()) {
          ...
          PlayerVideoGames player = new PlayerVideoGames(id, name, score);
