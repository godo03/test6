...
public class DatabaseHelperAnime extends SQLiteOpenHelper {

    public static int DB_VERSION = 1;
    public static String DB_NAME = "PlayerAnime.db";
    ...
    public DatabaseHelperAnime(@Nullable Context context) {
    ...
    public boolean deleteData (PlayerAnime id){
    ...
    public void insertData(String name, String score){
        ...
        ArrayList<PlayerAnime> playerArrayList = new ArrayList<>();
   ...
   */
  public ArrayList<PlayerAnime> getAllData(){
      ArrayList<PlayerAnime> playerArrayList = new ArrayList<>();
      ...
      while (cursor.moveToNext()) {
          ...
          PlayerAnime player = new PlayerAnime(id, name, score);
