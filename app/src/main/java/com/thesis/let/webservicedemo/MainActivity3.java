...
import com.thesis.let.webservicedemo.screens.ResultActivity3;
...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDb = new DatabaseHelperVideoGames(this);
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (timeValue == -1 && qid > 9) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            onStop();
                            Toast.makeText(MainActivity3.this, "Loading questions... Please wait", Toast.LENGTH_LONG).show();
    ...
    public void meh(){
        ...
        Intent intent = new Intent (this, ResultActivity3.class);
    ...
    public void bundleClick(){
        Intent i = new Intent(this, ResultActivity3.class);
        qcount=0;
    ...
    void loadQ()
    {
        ...
        if ((token!=null))
            ...
            url ="&category=15";
        url = "https://opentdb.com/api.php?amount=10&category=15"+url;
    ...
    public void endGameDialog(Integer score) {
        final Dialog endDialog = new Dialog(MainActivity3.this);
