...
public class MyAdapterSports extends BaseAdapter {

    Context context;
    ArrayList <PlayerSports> playerArrayList;

    public MyAdapterSports(Context context, ArrayList<PlayerSports> playerArrayList){
  ...
  /*  @Override
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        result = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_sports, viewGroup, false);
       ...
       TextView idtv = result.findViewById(R.id.id_item_list);
        ...
        PlayerSports player = playerArrayList.get(position);
