...
public class DatabaseHelperSports extends SQLiteOpenHelper {
    ...
    public static String DB_NAME = "PlayerSports.db";
    ...
    public DatabaseHelperSports(@Nullable Context context) {
    ...
    public boolean deleteData (PlayerSports id){
   ...
   */
  public ArrayList<PlayerSports> getAllData(){
      ArrayList<PlayerSports> playerArrayList = new ArrayList<>();
      ...
      while (cursor.moveToNext()) {
          ...
          PlayerSports player = new PlayerSports(id, name, score);
