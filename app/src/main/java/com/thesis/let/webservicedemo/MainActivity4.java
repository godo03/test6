...
import com.thesis.let.webservicedemo.screens.ResultActivity4;
...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDb = new DatabaseHelperSports(this);
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (timeValue == -1 && qid > 9) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            onStop();
                            Toast.makeText(MainActivity4.this, "Loading questions... Please wait", Toast.LENGTH_LONG).show();
    ...
    public void bundleClick(){
        Intent i = new Intent(MainActivity4.this, ResultActivity4.class);
        qcount=0;
    ...
    void loadQ()
    {
        ...
        if ((token!=null))
            ...
            url ="&category=21";
        url = "https://opentdb.com/api.php?amount=10&category=21"+url;
    ...
    public void endGameDialog(Integer score) {
        final Dialog endDialog = new Dialog(MainActivity4.this);
