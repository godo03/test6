...
public class DatabaseHelperBooks extends SQLiteOpenHelper {
    ...
    public static String DB_NAME = "PlayerBooks.db";
    ...
    public boolean deleteData (PlayerBooks id){
    ...
    public void insertData(String name, String score){
        ...
        ArrayList<PlayerBooks> playerArrayList = new ArrayList<>();
   ...
   */
  public ArrayList<PlayerBooks> getAllData(){
      ArrayList<PlayerBooks> playerArrayList = new ArrayList<>();
      ...
      while (cursor.moveToNext()) {
          ...
          PlayerBooks player = new PlayerBooks(id, name, score);
